import { AutoFreeHint, ContextualHint, DynamicHint, Hint, HintState, HintType, StaticHint, UserPointsState } from "../../types/hint";
...
export const isStaticHint = (hint: Hint): hint is StaticHint => {
  return [HintType.CUSTOM, HintType.CATEGORY, HintType.REGION].includes(hint.type);
};
