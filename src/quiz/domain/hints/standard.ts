...
import { HintType, type StandardHint } from "../../types/hint";
...
function generateStandardHintContent(
	hintType: HintType,
 ...
 */
export function generateAllHints(
	question: QuestionBase,
): (StandardHint | CustomHint | ContextualHint | AutoFreeHint)[] {
	const allHints: (
		| StandardHint
		| CustomHint
		| ContextualHint
