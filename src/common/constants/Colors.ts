...
export const Colors = {
  light: {
    ...
    gradientSecondary: ['#FF6B6B', '#FFE66D', '#FF8E53'] as [string, string, ...string[]],
    gradientNeutral: ['#E8EAF6', '#C5CAE9', '#9FA8DA'] as [string, string, ...string[]],
    gradientSuccess: ['#66BB6A', '#81C784', '#A5D6A7'] as [string, string, ...string[]],
  },
  dark: {
    text: '#ECEDEE',
    background: '#151718',
    ...
    gradientSecondary: ['#2C1810', '#3D2817', '#4A3728'] as [string, string, ...string[]],
    gradientNeutral: ['#2E2E2E', '#3A3A3A', '#464646'] as [string, string, ...string[]],
    gradientSuccess: ['#1B5E20', '#2E7D32', '#388E3C'] as [string, string, ...string[]],
  },
};