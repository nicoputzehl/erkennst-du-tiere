	...
	autoFreeHints: [
		{
			...
			content:
				"Dieser große, flugunfähige Vogel war nur auf der Insel Mauritius im Indischen Ozean beheimatet.",
		...
		},
		{
			...
			type: HintType.AUTO_FREE,
			content:
				"Er war mit den heutigen Tauben verwandt und wurde von Seeleuten wegen seines Fleisches gejagt und durch eingeschleppte Tiere bedroht.",
	...
	contextualHints: [
		{
			...
			content:
				"Dieser Vogel war nur etwa einen Meter hoch und stammte von Mauritius, nicht aus Afrika oder Madagaskar.",
	...
	customHints: [
		{
			...
			content:
				'Eine berühmte Figur dieses Vogels erscheint in Lewis Carrolls Buch "Alice im Wunderland".',
			cost: 1,
		},
	],
};
	...
	autoFreeHints: [
		{
			...
			type: HintType.AUTO_FREE,
			content:
				"Dieses Tier lebte in Südafrika und wurde Ende des 19. Jahrhunderts wegen seines Fells und als Konkurrenz zu Nutztieren ausgerottet.",
			triggerAfterAttempts: 3,
		},
		{
			id: "quagga_h2",
			type: HintType.AUTO_FREE,
			content:
				"Es war nur an Kopf und Hals kräftig schwarz-weiß gestreift; die Streifen verblassten zum hinteren Rumpf hin zu einem einfarbigen Braun.",
			triggerAfterAttempts: 6,
		},
	],
	contextualHints: [
		{
			...
			type: HintType.CONTEXTUAL,
			content:
				"Es ist nur teilweise gestreift; die Streifen bedecken nicht den gesamten Körper bis zu den Hufen.",
	...
	autoFreeHints: [
		{
			...
			type: HintType.AUTO_FREE,
			content:
				"Diese Gliederfüßer (Arthropoden) waren reine Meeresbewohner und existierten vom Kambrium bis zum Perm, also während des gesamten Erdaltertums (Paläozoikum).",
			triggerAfterAttempts: 3,
		},
		{
			id: "trilobit_h2",
			type: HintType.AUTO_FREE,
			content:
				"Sie sind eine der divergentesten Gruppen ausgestorbener Lebewesen und heute nur noch als Fossilien zu finden.",
			triggerAfterAttempts: 6,
		},
	],
	contextualHints: [
		{
			...
			type: HintType.CONTEXTUAL,
			content:
				"Der gesuchte ist ein urzeitlicher Meeresschädling und kein Insekt oder Reptil.",
	...
	customHints: [
		{
			...
			content:
				"Er starb beim größten Massenaussterben der Erdgeschichte am Ende des Perms vor etwa 251 Millionen Jahren.",
			cost: 1,
		},
	],
};
	...
	autoFreeHints: [
		{
			...
			type: HintType.AUTO_FREE,
			content:
				"Diese Großkatze der Eiszeit zeichnete sich durch extrem lange, dolchartige obere Eckzähne aus, die bis zu 20 cm lang werden konnten.",
			triggerAfterAttempts: 3,
		},
		{
			...
			type: HintType.AUTO_FREE,
			content:
				"Sie jagte große Pflanzenfresser wie Mammute und starb am Ende der letzten Eiszeit vor etwa 10.000 Jahren aus.",
			triggerAfterAttempts: 6,
		},
	],
	contextualHints: [
		{
			...
			type: HintType.CONTEXTUAL,
			content:
				'Der gesuchte ist ein ausgestorbenes Tier mit unverhältnismäßig großen Eckzähnen, aber kein "normaler" Tiger.',
	...
	customHints: [
		{
			...
			content:
				"Die langen Zähne waren sehr empfindlich und konnten leicht abbrechen, weshalb sie erst eingesetzt wurden, wenn das Opfer am Boden lag.",
			cost: 1,
		},
	],
};
	...
	autoFreeHints: [
		{
			...
			type: HintType.AUTO_FREE,
			content:
				"Dieses ausgestorbene, riesige Säugetier war eng mit dem heutigen Elefanten verwandt.",
			triggerAfterAttempts: 3,
		},
		{
			id: "mammut_h2",
			type: HintType.AUTO_FREE,
			content:
				"Das Wollhaarmammut war durch ein dichtes Fell und sehr lange, gebogene Stoßzähne an das Leben in der Eiszeit angepasst.",
			triggerAfterAttempts: 6,
		},
	],
	contextualHints: [
		{
			...
			type: HintType.CONTEXTUAL,
			content:
				"Der gesuchte hat dichtes Fell und sehr stark gekrümmte Stoßzähne; er lebte in der Kälte.",
	...
	customHints: [
		{
			...
			content:
				'Wissenschaftler arbeiten daran, die DNA dieser Tiere zu nutzen, um sie durch Klonen mit Elefanten-DNA "wiederzubeleben".',
			cost: 1,
		},
	],
};
	...
	autoFreeHints: [
		{
			...
			type: HintType.AUTO_FREE,
			content:
				"Dieses Raubtier war ursprünglich auf dem australischen Festland und bis ins 20. Jahrhundert auf Tasmanien beheimatet.",
			triggerAfterAttempts: 3,
		},
		{
			id: "beutelwolf_h2",
			type: HintType.AUTO_FREE,
			content:
				'Sein auffälligstes Merkmal waren die dunklen Querstreifen am unteren Rücken und Schwanzansatz, die ihm den Beinamen "Tiger" gaben.',
			triggerAfterAttempts: 6,
		},
	],
	contextualHints: [
		{
			...
			type: HintType.CONTEXTUAL,
			content:
				"Der gesuchte ist ein Beuteltier und hat Streifen; er wurde wahrscheinlich durch den Dingo vom australischen Festland verdrängt.",
			title: "Kein Dingo!",
	...
	autoFreeHints: [
		{
			...
			type: HintType.AUTO_FREE,
			content:
				"Dieser flugunfähige Laufvogel war ausschließlich auf der Insel Madagaskar beheimatet und starb vermutlich im 13. bis 17. Jahrhundert aus.",
			triggerAfterAttempts: 3,
		},
		{
			...
			type: HintType.AUTO_FREE,
			content:
				"Er legte das größte Vogelei der Welt, das einem Volumen von etwa 100 Hühnereiern entsprach.",
			triggerAfterAttempts: 6,
		},
	],
	contextualHints: [
		{
			...
			type: HintType.CONTEXTUAL,
			content:
				"Der gesuchte war doppelt so groß und schwer wie der heutige Strauß und lebte in Madagaskar.",
	...
	customHints: [
		{
			...
			title: "Begehrte Eier",
			content:
				"Ein einzelnes Ei ist heute ein begehrtes und extrem teures Sammelobjekt.",
			cost: 1,
		},
	],
};
	...
	autoFreeHints: [
		{
			...
			type: HintType.AUTO_FREE,
			content:
				"Dieser kleine Froschlurch war nur in einem winzigen Gebiet im Monteverde-Nebelwald von Costa Rica beheimatet.",
			triggerAfterAttempts: 3,
		},
		{
			id: "goldkroete_h2",
			type: HintType.AUTO_FREE,
			content:
				"Die Männchen waren durch eine einzigartige, leuchtend gelb-orange Farbe gekennzeichnet.",
			triggerAfterAttempts: 6,
		},
	],
	contextualHints: [
		{
			...
			type: HintType.CONTEXTUAL,
			content:
				'Der gesuchte ist eine Kröte mit rauer, trockener Haut und keine "glatte" Froschart.',
	...
	customHints: [
		{
			...
			content:
				"Als Hauptgrund für ihr Verschwinden werden der Klimawandel und eine Pilzerkrankung (Chytridiomykose) vermutet.",
			cost: 1,
		},
	],
};
